...
| **Why** | Demonstrates disciplined, auditable ML search, end to end from frozen harness to deployed service |
...
## The pages
- **[Problem definition](../problem_definition.md)** is the scope contract: what's in,
...
- **Written report** [`report/`](../../report) is a Quarto website (data →
  methodology → results → **model exploration** → the pivot → limitations). Render
  with `quarto render report`.
- **Interactive app** [`app/`](../../app) is a Streamlit front door (live
...
- **The search architecture** [`src/harness/`](../../src/harness) is the frozen
